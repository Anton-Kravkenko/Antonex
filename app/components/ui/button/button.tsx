...
import {buttonBackground, buttonPadding, fontSize} from "@/app/components/ui/button/button-settings";
...
const Button:FC<PropsWithChildren<ButtonProps>> = ({children, style, className, ...props}) => {
	const button = <div className={`${hoverAnimation} ${className} font-bold cursor-pointer`} style={{
