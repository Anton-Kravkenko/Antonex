...
export interface IconProps extends stylesProps, ColorProps, IconTypeProps, clickProps{
	size?: number
	href?: string
}
const Icon:FC<IconProps> = ({className,  ...props}) => {
	const icon =<props.icon className={`${hoverAnimation} ${className}`} size={props.size} color={props.color}/>
